...
- USB: FT2232HL (Ch A: MPSSE SPI -> Flash, Ch B: UART <-> FPGA)
...
- Board: 61mm x 26mm, 4-layer FR4 (JLCPCB)
...
| ------- | -------------------------------- | ------------- | ---------------------- | ------ | ---------------------------------------------------------------------------------------------- |
| U1      | [FT2232HL](data/FT2232H.pdf)     | LQFP-64       | Dual USB UART/MPSSE    | $5.87  | [lcsc](https://lcsc.com/product-detail/USB-ICs_Future-Designs-FT2232HL-REEL_C27882.html)       |
| U2      | W25Q32JVSSIM                     | SOIC-8 208mil | 32Mbit SPI Flash       | -      | [digikey](https://www.digikey.com/en/products/result?keywords=W25Q32JVSSIM)                    |
...
| C26-C27 | 10uF  | 0805 | 2   | FT2232H VREGOUT/VCORE / iCE40 VCCPLL       |
...
| R8-R11  | 10k   | 0402 | 4   | Pull-ups: FT RESET#, CRESET_B, SPI_SS, BTN |
...
| SW1-SW2 | Tact  | SMD  | 2   | RESET / USER button                        |
